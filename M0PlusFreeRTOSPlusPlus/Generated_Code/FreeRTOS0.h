...
#ifndef __FreeRTOS0_H
#define __FreeRTOS0_H
...
#define FreeRTOS0_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */
...
#define PEX_RTOS_START()               FreeRTOS0_vTaskStartScheduler()
...
#define FreeRTOS0_xTaskCreate(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask) \
...
#define FreeRTOS0_vTaskDelete(pxTask) \
        vTaskDelete(pxTask)
/*
** ===================================================================
...
#define FreeRTOS0_vTaskStartScheduler() \
  vTaskStartScheduler()
/*
** ===================================================================
...
#define FreeRTOS0_taskENTER_CRITICAL() \
  taskENTER_CRITICAL()
/*
** ===================================================================
...
#define FreeRTOS0_taskEXIT_CRITICAL() \
  taskEXIT_CRITICAL()
/*
** ===================================================================
...
#define FreeRTOS0_taskDISABLE_INTERRUPTS() \
...
#define FreeRTOS0_taskENABLE_INTERRUPTS() \
...
#define FreeRTOS0_vTaskSuspendAll() \
  vTaskSuspendAll()
/*
** ===================================================================
...
#define FreeRTOS0_xTaskResumeAll() \
  xTaskResumeAll()
/*
** ===================================================================
...
#define FreeRTOS0_vTaskDelay(xTicksToDelay) \
...
#define FreeRTOS0_vTaskDelayUntil(pxPreviousWakeTime, xTimeIncrement) \
...
#define FreeRTOS0_uxTaskPriorityGet(pxTask) \
...
#define FreeRTOS0_vTaskPrioritySet(pxTask, uxNewPriority) \
...
#define FreeRTOS0_xSemaphoreTakeRecursive(xMutex, xBlockTime) \
...
#define FreeRTOS0_xSemaphoreGiveRecursive(xMutex) \
...
#define FreeRTOS0_xSemaphoreCreateRecursiveMutex() \
  xSemaphoreCreateRecursiveMutex()
...
#define FreeRTOS0_vTaskSuspend(pxTaskToSuspend) \
...
#define FreeRTOS0_vTaskResume(pxTaskToResume) \
...
#define FreeRTOS0_xSemaphoreCreateMutex() \
  xSemaphoreCreateMutex()
...
#define FreeRTOS0_xSemaphoreTake(xMutex, xBlockTime) \
...
#define FreeRTOS0_xSemaphoreGive(xMutex) \
...
#define FreeRTOS0_vSemaphoreCreateBinary(xSemaphore) \
...
#define FreeRTOS0_xSemaphoreCreateCounting(uxMaxCount, uxInitialCount) \
...
#define FreeRTOS0_xSemaphoreGiveFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS0_vSemaphoreDelete(xSemaphore) \
...
#define FreeRTOS0_pvPortMalloc(xWantedSize) \
...
#define FreeRTOS0_xTaskGetTickCount() \
  xTaskGetTickCount()
/*
** ===================================================================
...
#define FreeRTOS0_xTaskGetSchedulerState() \
...
#define FreeRTOS0_uxTaskGetStackHighWaterMark(xTask) \
...
#define FreeRTOS0_uxTaskGetNumberOfTasks() \
...
#define FreeRTOS0_xPortGetFreeHeapSize() \
...
#define FreeRTOS0_xQueueCreate(uxQueueLength, uxItemSize) \
...
#define FreeRTOS0_xQueueSendToFront(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FreeRTOS0_xQueueSendToBack(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FreeRTOS0_xQueueReceive(xQueue, pvBuffer, xTicksToWait) \
...
#define FreeRTOS0_xQueuePeek(xQueue, pvBuffer, xTicksToWait) \
...
#define FreeRTOS0_vQueueDelete(pxQueueToDelete) \
...
#define FreeRTOS0_uxQueueMessagesWaiting(xQueue) \
...
#define FreeRTOS0_uxQueueMessagesWaitingfromISR(xQueue) \
...
#define FreeRTOS0_xQueueReceiveFromISR(xQueue, pvBuffer, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS0_xQueueSendToFrontFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS0_xQueueSendToBackFromISR(xQueue, pvItemToQueue,pxHigherPriorityTaskWoken) \
...
#define FreeRTOS0_xTaskResumeFromISR(pxTaskToResume) \
...
#define FreeRTOS0_xQueueReset(xQueue) \
  xQueueReset(xQueue)
...
#define FreeRTOS0_xSemaphoreGetMutexHolder(xSemaphore) \
...
#define FreeRTOS0_xSemaphoreTakeFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS0_xTaskGetTickCountFromISR() \
...
#define FreeRTOS0_xQueuePeekFromISR(xQueue, pvBuffer, xTicksToWait) \
...
#define FreeRTOS0_xQueueOverwrite(xQueue, pvItemToQueue) \
...
#define FreeRTOS0_xQueueOverwriteFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS0_vQueueAddToRegistry(xQueue, pcQueueName) \
...
#define FreeRTOS0_vQueueUnregisterQueue(xQueue) \
...
#define FreeRTOS0_xQueueIsQueueFullFromISR(xQueue) \
...
#define FreeRTOS0_xQueueIsQueueEmptyFromISR(xQueue) \
