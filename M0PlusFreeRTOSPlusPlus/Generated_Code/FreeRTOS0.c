...
**         vTaskDelete                    - void FreeRTOS0_vTaskDelete(xTaskHandle pxTask);
**         vTaskStartScheduler            - void FreeRTOS0_vTaskStartScheduler(void);
**         vTaskSuspend                   - void FreeRTOS0_vTaskSuspend(xTaskHandle pxTaskToSuspend);
**         vTaskSuspendAll                - void FreeRTOS0_vTaskSuspendAll(void);
**         vTaskResume                    - void FreeRTOS0_vTaskResume(xTaskHandle pxTaskToResume);
**         xTaskResumeAll                 - portBASE_TYPE FreeRTOS0_xTaskResumeAll(void);
**         xTaskResumeFromISR             - portBASE_TYPE FreeRTOS0_xTaskResumeFromISR(xTaskHandle pxTaskToResume);
**         taskYIELD                      - void FreeRTOS0_taskYIELD(void);
**         taskENTER_CRITICAL             - void FreeRTOS0_taskENTER_CRITICAL(void);
**         taskEXIT_CRITICAL              - void FreeRTOS0_taskEXIT_CRITICAL(void);
**         taskDISABLE_INTERRUPTS         - void FreeRTOS0_taskDISABLE_INTERRUPTS(void);
**         taskENABLE_INTERRUPTS          - void FreeRTOS0_taskENABLE_INTERRUPTS(void);
**         vTaskDelay                     - void FreeRTOS0_vTaskDelay(portTickType xTicksToDelay);
**         vTaskDelayUntil                - void FreeRTOS0_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType...
**         uxTaskPriorityGet              - unsigned_portBASE_TYPE FreeRTOS0_uxTaskPriorityGet(xTaskHandle pxTask);
**         vTaskPrioritySet               - void FreeRTOS0_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE...
**         xTaskGetTickCount              - portTickType FreeRTOS0_xTaskGetTickCount(void);
**         xTaskGetTickCountFromISR       - portTickType FreeRTOS0_xTaskGetTickCountFromISR(void);
**         xSemaphoreCreateRecursiveMutex - xSemaphoreHandle FreeRTOS0_xSemaphoreCreateRecursiveMutex(void);
**         xSemaphoreTakeRecursive        - bool FreeRTOS0_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType...
**         xSemaphoreGiveRecursive        - bool FreeRTOS0_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex);
**         xSemaphoreCreateMutex          - xSemaphoreHandle FreeRTOS0_xSemaphoreCreateMutex(void);
**         xSemaphoreTake                 - bool FreeRTOS0_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime);
**         xSemaphoreGive                 - bool FreeRTOS0_xSemaphoreGive(xSemaphoreHandle xMutex);
**         vSemaphoreCreateBinary         - void FreeRTOS0_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore);
**         xSemaphoreCreateCounting       - xSemaphoreHandle FreeRTOS0_xSemaphoreCreateCounting(unsigned_portBASE_TYPE...
**         xSemaphoreGiveFromISR          - bool FreeRTOS0_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore,...
**         xSemaphoreTakeFromISR          - bool FreeRTOS0_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore,...
**         vSemaphoreDelete               - void FreeRTOS0_vSemaphoreDelete(xSemaphoreHandle xSemaphore);
**         xSemaphoreGetMutexHolder       - void* FreeRTOS0_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore);
**         pvPortMalloc                   - pVoid FreeRTOS0_pvPortMalloc(size_t xWantedSize);
**         vPortFree                      - void FreeRTOS0_vPortFree(void *pv);
**         xPortGetFreeHeapSize           - Tsize_t FreeRTOS0_xPortGetFreeHeapSize(void);
**         xTaskGetSchedulerState         - portBASE_TYPE FreeRTOS0_xTaskGetSchedulerState(void);
**         uxTaskGetStackHighWaterMark    - unsigned_portBASE_TYPE FreeRTOS0_uxTaskGetStackHighWaterMark(xTaskHandle xTask);
**         uxTaskGetNumberOfTasks         - unsigned_portBASE_TYPE FreeRTOS0_uxTaskGetNumberOfTasks(void);
**         uxQueueMessagesWaiting         - unsigned_portBASE_TYPE FreeRTOS0_uxQueueMessagesWaiting(xQueueHandle xQueue);
**         uxQueueMessagesWaitingfromISR  - unsigned_portBASE_TYPE FreeRTOS0_uxQueueMessagesWaitingfromISR(xQueueHandle...
**         xQueueCreate                   - xQueueHandle FreeRTOS0_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength,...
**         vQueueDelete                   - void FreeRTOS0_vQueueDelete(xQueueHandle pxQueueToDelete);
**         xQueueReset                    - portBASE_TYPE FreeRTOS0_xQueueReset(xQueueHandle xQueue);
**         xQueueSendToBack               - portBASE_TYPE FreeRTOS0_xQueueSendToBack(xQueueHandle xQueue, const void...
**         xQueueSendToFront              - portBASE_TYPE FreeRTOS0_xQueueSendToFront(xQueueHandle xQueue, const void...
**         xQueueReceive                  - portBASE_TYPE FreeRTOS0_xQueueReceive(xQueueHandle xQueue, void *pvBuffer,...
**         xQueueOverwrite                - portBASE_TYPE FreeRTOS0_xQueueOverwrite(xQueueHandle xQueue, const void...
**         xQueueOverwriteFromISR         - portBASE_TYPE FreeRTOS0_xQueueOverwriteFromISR(xQueueHandle xQueue, const...
**         xQueuePeek                     - portBASE_TYPE FreeRTOS0_xQueuePeek(xQueueHandle xQueue, void *pvBuffer,...
**         xQueuePeekFromISR              - portBASE_TYPE FreeRTOS0_xQueuePeekFromISR(xQueueHandle xQueue, void...
**         xQueueSendToBackFromISR        - portBASE_TYPE FreeRTOS0_xQueueSendToBackFromISR(xQueueHandle xQueue, const...
**         xQueueSendToFrontFromISR       - portBASE_TYPE FreeRTOS0_xQueueSendToFrontFromISR(xQueueHandle xQueue, const...
**         xQueueReceiveFromISR           - portBASE_TYPE FreeRTOS0_xQueueReceiveFromISR(xQueueHandle xQueue, void...
**         vQueueAddToRegistry            - void FreeRTOS0_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName);
...
*/         
/*!
**  @addtogroup FreeRTOS0_module FreeRTOS0 module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xTaskCreate (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR * const pcName, unsigned portSHORT usStackDepth, void *pvParameters, unsigned portBASE_TYPE uxPriority, xTaskHandle *pvCreatedTask)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/

/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskDelete(xTaskHandle pxTask)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskStartScheduler (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskStartScheduler(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_taskYIELD (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_taskENTER_CRITICAL (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_taskENTER_CRITICAL(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_taskEXIT_CRITICAL (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_taskEXIT_CRITICAL(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_taskDISABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_taskDISABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_taskENABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_taskENABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskSuspendAll (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskSuspendAll(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xTaskResumeAll (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xTaskResumeAll(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xTaskResumeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xTaskResumeFromISR(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskDelay (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskDelay(portTickType xTicksToDelay)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskDelayUntil (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType xTimeIncrement)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_uxTaskPriorityGet (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS0_uxTaskPriorityGet(xTaskHandle pxTask)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskPrioritySet (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE uxNewPriority)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreTakeRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS0_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreGiveRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS0_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreCreateRecursiveMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FreeRTOS0_xSemaphoreCreateRecursiveMutex(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vSemaphoreDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vSemaphoreDelete(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskSuspend (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskSuspend(xTaskHandle pxTaskToSuspend)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vTaskResume (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vTaskResume(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreCreateMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FreeRTOS0_xSemaphoreCreateMutex(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreTake (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS0_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreGive (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS0_xSemaphoreGive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vSemaphoreCreateBinary (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreCreateCounting (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FreeRTOS0_xSemaphoreCreateCounting(unsigned_portBASE_TYPE uxMaxCount, unsigned_portBASE_TYPE uxInitialCount)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreGiveFromISR (component FreeRTOS)
**     Description :
**         Macro to release a semaphore. The semaphore must have
**         previously been created with a call to
...
*/
/*
bool FreeRTOS0_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_pvPortMalloc (component FreeRTOS)
**     Description :
...
*/
/*
pVoid FreeRTOS0_pvPortMalloc(size_t xWantedSize)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vPortFree (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vPortFree(void *pv)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xTaskGetTickCount (component FreeRTOS)
**     Description :
...
*/
/*
portTickType FreeRTOS0_xTaskGetTickCount(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xTaskGetSchedulerState (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xTaskGetSchedulerState(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_uxTaskGetStackHighWaterMark (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS0_uxTaskGetStackHighWaterMark(xTaskHandle xTask)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_uxTaskGetNumberOfTasks (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS0_uxTaskGetNumberOfTasks(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xPortGetFreeHeapSize (component FreeRTOS)
**     Description :
...
*/
/*
Tsize_t FreeRTOS0_xPortGetFreeHeapSize(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueCreate (component FreeRTOS)
**     Description :
**         Creates a queue.
**     Parameters  :
**         NAME            - DESCRIPTION
...
*/
/*
xQueueHandle FreeRTOS0_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength, unsigned_portBASE_TYPE uxItemSize)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueSendToFront (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueSendToFront(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueSendToBack (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueSendToBack(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueReceive (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueReceive(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueuePeek (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueuePeek(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vQueueDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vQueueDelete(xQueueHandle pxQueueToDelete)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_uxQueueMessagesWaiting (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS0_uxQueueMessagesWaiting(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_uxQueueMessagesWaitingfromISR (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS0_uxQueueMessagesWaitingfromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueReceiveFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueReceiveFromISR(xQueueHandle xQueue, void *pvBuffer, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueSendToFrontFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueSendToFrontFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueSendToBackFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueSendToBackFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueReset (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueReset(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreGetMutexHolder (component FreeRTOS)
**     Description :
...
*/
/*
void* FreeRTOS0_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xSemaphoreTakeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS0_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_Init (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xTaskGetTickCountFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portTickType FreeRTOS0_xTaskGetTickCountFromISR(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueuePeekFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueuePeekFromISR(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueOverwrite (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueOverwrite(xQueueHandle xQueue, const void *pvItemToQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueOverwriteFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueOverwriteFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vQueueAddToRegistry (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_vQueueUnregisterQueue (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS0_vQueueUnregisterQueue(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueIsQueueFullFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueIsQueueFullFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS0_xQueueIsQueueEmptyFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS0_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventGroupHandle_t FreeRTOS0_xEventGroupCreate(void)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
byte FreeRTOS0_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupSetBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet , BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupClearBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupGetBits(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
...
*/
/*
EventBits_t FreeRTOS0_xEventGroupSync(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS0.h
}
*/
