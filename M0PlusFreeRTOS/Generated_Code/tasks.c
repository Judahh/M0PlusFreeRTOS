...
#else /* << EST */
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName);
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_chcat(pcWriteBuffer, bufSize, (unsigned char)cStatus);
              UTIL0_chcat(pcWriteBuffer, bufSize, (unsigned char)'\t');
              UTIL0_strcatNum32u((unsigned char*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].uxCurrentPriority);
              UTIL0_chcat(pcWriteBuffer, bufSize, (unsigned char)'\t');
              UTIL0_strcatNum32u(pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].usStackHighWaterMark);
              UTIL0_chcat(pcWriteBuffer, bufSize, (unsigned char)'\t');
              UTIL0_strcatNum32u(pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].xTaskNumber);
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\r\n");
#endif
...
/*----------------------------------------------------------*/
        ...
        unsigned long ulTotalTime, ulStatsAsPercentage;
              ...
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName);
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_strcatNum32u((unsigned char*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_strcatNum32u(pcWriteBuffer, bufSize, ulStatsAsPercentage);
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"%\r\n");
#endif
                                                }
                                                #endif
              ...
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_strcatNum32u((unsigned char*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              UTIL0_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t<1%\r\n");
#endif
                                                }
                                                #endif
                                        }
