...
#include "UTIL0.h" /* interface to utility because used for safe string routines */ /* << EST */
#endif
...
BaseType_t xSwitchRequired = pdFALSE;
        ...
        if( uxSchedulerSuspended == ( UBaseType_t ) pdFALSE )
        {
                ...
                #if ( configUSE_TICK_HOOK == 1 )
                {
                        ...
                        {
      extern void vApplicationTickHook( void );
      FreeRTOS0_vApplicationTickHook();
                        }
                        else
                        {
                                mtCOVERAGE_TEST_MARKER();
...
static portTASK_FUNCTION( prvIdleTask, pvParameters )
{
        ...
        for( ;; )
        {
                ...
                #if ( configUSE_IDLE_HOOK == 1 )
                {
                        ...
                        FreeRTOS0_vApplicationIdleHook();
                }
...
#else /* << EST */
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName);
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)cStatus);
              UTIL0_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)'\t');
              UTIL0_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].uxCurrentPriority);
              UTIL0_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)'\t');
              UTIL0_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].usStackHighWaterMark);
              UTIL0_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)'\t');
              UTIL0_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].xTaskNumber);
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\r\n");
#endif
                        }
...
/*----------------------------------------------------------*/
        ...
        uint32_t ulTotalTime, ulStatsAsPercentage;
              ...
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName);
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, ulStatsAsPercentage);
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"%\r\n");
#endif
                                                }
                                                #endif
              ...
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL0_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              UTIL0_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t<1%\r\n");
#endif
                                                }
                                                #endif
                                        }
