...
**     Contents    :
**         strcpy                  - void UTIL2_strcpy(byte *dst, size_t dstSize, const unsigned char *src);
**         strcat                  - void UTIL2_strcat(byte *dst, size_t dstSize, const unsigned char *src);
**         chcat                   - void UTIL2_chcat(byte *dst, size_t dstSize, byte ch);
**         Num8sToStr              - void UTIL2_Num8sToStr(byte *dst, size_t dstSize, signed char val);
**         Num8uToStr              - void UTIL2_Num8uToStr(byte *dst, size_t dstSize, byte val);
**         Num16sToStr             - void UTIL2_Num16sToStr(byte *dst, size_t dstSize, int16_t val);
**         Num16uToStr             - void UTIL2_Num16uToStr(byte *dst, size_t dstSize, word val);
**         Num32uToStr             - void UTIL2_Num32uToStr(byte *dst, size_t dstSize, dword val);
**         Num32sToStr             - void UTIL2_Num32sToStr(byte *dst, size_t dstSize, long val);
**         Num16sToStrFormatted    - void UTIL2_Num16sToStrFormatted(byte *dst, size_t dstSize, int16_t val, char...
**         Num16uToStrFormatted    - void UTIL2_Num16uToStrFormatted(byte *dst, size_t dstSize, word val, char...
**         Num32uToStrFormatted    - void UTIL2_Num32uToStrFormatted(byte *dst, size_t dstSize, dword val, char...
**         Num32sToStrFormatted    - void UTIL2_Num32sToStrFormatted(byte *dst, size_t dstSize, long val, char...
**         strcatNum8u             - void UTIL2_strcatNum8u(byte *dst, size_t dstSize, byte val);
**         strcatNum8s             - void UTIL2_strcatNum8s(byte *dst, size_t dstSize, signed char val);
**         strcatNum16u            - void UTIL2_strcatNum16u(byte *dst, size_t dstSize, word val);
**         strcatNum16s            - void UTIL2_strcatNum16s(byte *dst, size_t dstSize, int16_t val);
**         strcatNum32u            - void UTIL2_strcatNum32u(byte *dst, size_t dstSize, dword val);
**         strcatNum32s            - void UTIL2_strcatNum32s(byte *dst, size_t dstSize, long val);
**         strcatNum16uFormatted   - void UTIL2_strcatNum16uFormatted(byte *dst, size_t dstSize, word val, char...
**         strcatNum16sFormatted   - void UTIL2_strcatNum16sFormatted(byte *dst, size_t dstSize, int16_t val, char...
**         strcatNum32uFormatted   - void UTIL2_strcatNum32uFormatted(byte *dst, size_t dstSize, dword val, char...
**         strcatNum32sFormatted   - void UTIL2_strcatNum32sFormatted(byte *dst, size_t dstSize, long val, char...
**         strcatNum8Hex           - void UTIL2_strcatNum8Hex(byte *dst, size_t dstSize, byte num);
**         strcatNum16Hex          - void UTIL2_strcatNum16Hex(byte *dst, size_t dstSize, word num);
**         strcatNum24Hex          - void UTIL2_strcatNum24Hex(byte *dst, size_t dstSize, dword num);
**         strcatNum32Hex          - void UTIL2_strcatNum32Hex(byte *dst, size_t dstSize, dword num);
**         strcatNum32sDotValue100 - void UTIL2_strcatNum32sDotValue100(byte *dst, size_t dstSize, long num);
**         IsLeapYear              - bool UTIL2_IsLeapYear(word year);
**         WeekDay                 - byte UTIL2_WeekDay(word year, byte month, byte day);
**         ReadEscapedName         - byte UTIL2_ReadEscapedName(const unsigned char *filename, byte *destname,...
**         xatoi                   - byte UTIL2_xatoi(const unsigned char **str, int32_t *res);
**         ScanDate                - byte UTIL2_ScanDate(const unsigned char **str, byte *day, byte *month, word...
**         ScanTime                - byte UTIL2_ScanTime(const unsigned char **str, byte *hour, byte *minute, byte...
**         ScanDecimal8uNumber     - byte UTIL2_ScanDecimal8uNumber(const unsigned char **str, byte *val);
**         ScanDecimal8sNumber     - byte UTIL2_ScanDecimal8sNumber(const unsigned char **str, signed char *val);
**         ScanDecimal16uNumber    - byte UTIL2_ScanDecimal16uNumber(const unsigned char **str, word *val);
**         ScanDecimal16sNumber    - byte UTIL2_ScanDecimal16sNumber(const unsigned char **str, int16_t *val);
**         ScanDecimal32uNumber    - byte UTIL2_ScanDecimal32uNumber(const unsigned char **str, uint32_t *val);
**         ScanDecimal32sNumber    - byte UTIL2_ScanDecimal32sNumber(const unsigned char **str, uint32_t *val);
**         ScanHex8uNumber         - byte UTIL2_ScanHex8uNumber(const unsigned char **str, byte *val);
**         ScanHex8uNumberNoPrefix - byte UTIL2_ScanHex8uNumberNoPrefix(const unsigned char **str, byte *val);
**         ScanHex16uNumber        - byte UTIL2_ScanHex16uNumber(const unsigned char **str, word *val);
**         ScanHex32uNumber        - byte UTIL2_ScanHex32uNumber(const unsigned char **str, uint32_t *val);
**         strcmp                  - int16_t UTIL2_strcmp(const char *, const char *);
**         strncmp                 - int16_t UTIL2_strncmp(const char *, const char *, size_t size);
**         strFind                 - int16_t UTIL2_strFind(byte *str, byte *subStr);
**         strtailcmp              - byte UTIL2_strtailcmp(byte *str, byte *tail);
**         strlen                  - word UTIL2_strlen(const char *);
**         strCutTail              - byte UTIL2_strCutTail(byte *str, byte *tail);
**
...
*/
void UTIL2_strcpy(byte *dst, size_t dstSize, const unsigned char *src)
{
...
/*!
  ...
  */
void UTIL2_strcat(byte *dst, size_t dstSize, const unsigned char *src)
{
  dstSize--; /* for zero byte */
...
** ===================================================================
*/
void UTIL2_chcat(byte *dst, size_t dstSize, byte ch)
{
  dstSize--; /* for zero byte */
  /* point to the end of the source */
  while (dstSize > 0 && *dst != '\0') {
 ...
 */
void UTIL2_Num8uToStr(byte *dst, size_t dstSize, byte val)
{
 ...
 */
void UTIL2_Num8sToStr(byte *dst, size_t dstSize, signed char val)
{
 ...
 */
void UTIL2_Num16uToStr(byte *dst, size_t dstSize, word val)
{
 ...
 */
void UTIL2_Num16sToStr(byte *dst, size_t dstSize, int16_t val)
{
  unsigned char *ptr =  ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
*/
void UTIL2_Num16sToStrFormatted(byte *dst, size_t dstSize, int16_t val, char fill, byte nofFill)
{
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void UTIL2_Num16uToStrFormatted(byte *dst, size_t dstSize, word val, char fill, byte nofFill)
{
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void UTIL2_Num32uToStrFormatted(byte *dst, size_t dstSize, dword val, char fill, byte nofFill)
{
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void UTIL2_Num32sToStrFormatted(byte *dst, size_t dstSize, long val, char fill, byte nofFill)
{
...
/*!
  ...
  */
void UTIL2_strcatNum8u(byte *dst, size_t dstSize, byte val)
{
...
/*!
  ...
  */
void UTIL2_strcatNum8s(byte *dst, size_t dstSize, signed char val)
{
...
/*!
  ...
  \param[in] val The 16bit unsigned number to add
  */
void UTIL2_strcatNum16u(byte *dst, size_t dstSize, word val)
{
...
/*!
  ...
  \param[in] val The 16bit signed number to add
  */
void UTIL2_strcatNum16s(byte *dst, size_t dstSize, int16_t val)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */
...
/*!
  ...
  */
void UTIL2_strcatNum16uFormatted(byte *dst, size_t dstSize, word val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("32768")]; /* maximum buffer size we need */
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void UTIL2_strcatNum16sFormatted(byte *dst, size_t dstSize, int16_t val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void UTIL2_strcatNum32uFormatted(byte *dst, size_t dstSize, dword val, char fill, byte nofFill)
{
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void UTIL2_strcatNum32sFormatted(byte *dst, size_t dstSize, long val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */
...
/*!
  ...
  */
void UTIL2_strcatNum8Hex(byte *dst, size_t dstSize, byte num)
{
...
/*!
  ...
  */
void UTIL2_strcatNum16Hex(byte *dst, size_t dstSize, word num)
{
...
/*!
  ...
  */
void UTIL2_strcatNum24Hex(byte *dst, size_t dstSize, dword num)
{
...
/*!
  ...
  */
void UTIL2_strcatNum32Hex(byte *dst, size_t dstSize, dword num)
{
...
/*!
  ...
  */
void UTIL2_strcatNum32s(byte *dst, size_t dstSize, long val)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */
...
/*!
  ...
  \param[in] val The 32bit unsigned number to add
  */
void UTIL2_strcatNum32u(byte *dst, size_t dstSize, dword val)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */
 ...
 */
void UTIL2_Num32sToStr(byte *dst, size_t dstSize, long val)
{
  unsigned char *ptr =  ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
 ...
 */
void UTIL2_Num32uToStr(byte *dst, size_t dstSize, dword val)
{
  unsigned char *ptr = ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
** ===================================================================
*/
bool UTIL2_IsLeapYear(word year)
{
...
** ===================================================================
*/
byte UTIL2_WeekDay(word year, byte month, byte day)
{
...
** ===================================================================
*/
byte UTIL2_ReadEscapedName(const unsigned char *filename, byte *destname, size_t maxlen, size_t *lenRead, size_t *lenWritten, const char *terminators)
{
...
#endif
byte UTIL2_xatoi(const unsigned char **str, int32_t *res)
{
...
** ===================================================================
*/
byte UTIL2_ScanDate(const unsigned char **str, byte *day, byte *month, word *year)
{
...
** ===================================================================
*/
byte UTIL2_ScanTime(const unsigned char **str, byte *hour, byte *minute, byte *second, byte *hSecond)
{
...
** ===================================================================
*/
byte UTIL2_ScanDecimal8uNumber(const unsigned char **str, byte *val)
{
...
** ===================================================================
*/
byte UTIL2_ScanDecimal8sNumber(const unsigned char **str, signed char *val)
{
...
** ===================================================================
*/
byte UTIL2_ScanDecimal16uNumber(const unsigned char **str, word *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
** ===================================================================
*/
byte UTIL2_ScanDecimal16sNumber(const unsigned char **str, int16_t *val)
{
  /* Scans a decimal number, and stops at any non-number. Number can have any preceding spaces. */
  const unsigned char *p = *str;
  bool isNeg;
  ...
  *val = 0;
  ...
  res = UTIL2_ScanDecimal16uNumber(&p, &val16u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
** ===================================================================
*/
byte UTIL2_ScanDecimal32uNumber(const unsigned char **str, uint32_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
** ===================================================================
*/
byte UTIL2_ScanDecimal32sNumber(const unsigned char **str, uint32_t *val)
{
  /* Scans a decimal number, and stops at any non-number. Number can have any preceding spaces. */
  const unsigned char *p = *str;
  bool isNeg;
...
** ===================================================================
*/
byte UTIL2_ScanHex32uNumber(const unsigned char **str, uint32_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
** ===================================================================
*/
byte UTIL2_ScanHex16uNumber(const unsigned char **str, word *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
** ===================================================================
*/
byte UTIL2_ScanHex8uNumber(const unsigned char **str, byte *val)
{
...
** ===================================================================
*/
byte UTIL2_ScanHex8uNumberNoPrefix(const unsigned char **str, byte *val)
{
...
** ===================================================================
*/
byte UTIL2_strtailcmp(byte *str, byte *tail)
{
  int i, j;
...
** ===================================================================
*/
byte UTIL2_strCutTail(byte *str, byte *tail)
{
...
** ===================================================================
*/
void UTIL2_strcatNum32sDotValue100(byte *dst, size_t dstSize, long num)
{
  ...
  UTIL2_strcatNum16uFormatted(dst, dstSize, (uint16_t)(num%100), '0', 2);
}
...
** ===================================================================
*/
int16_t UTIL2_strFind(byte *str, byte *subStr)
{
  int i, len;
