...
} LedRed_TDeviceData;                  /* Device data structure type */

typedef LedRed_TDeviceData *LedRed_TDeviceDataPtr ; /* Pointer to the device data structure. */
...
LDD_TDeviceData* LedRed_Init(LDD_TUserData *UserDataPtr)
{
  ...
  LedRed_TDeviceDataPtr DeviceDataPrv;
...
bool LedRed_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  PortData = GPIO_PDD_GetPortDataOutput(LedRed_MODULE_BASE_ADDRESS) & LedRed_PORT_MASK;
...
void LedRed_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(LedRed_MODULE_BASE_ADDRESS, LedRed_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(LedRed_MODULE_BASE_ADDRESS, LedRed_PORT_MASK);
  } /* !Val */
}
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_TogglePortDataOutputMask(LedRed_MODULE_BASE_ADDRESS, LedRed_PORT_MASK);
}
