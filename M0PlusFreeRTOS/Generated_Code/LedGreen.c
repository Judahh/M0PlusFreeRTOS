...
} LedGreen_TDeviceData;                /* Device data structure type */

typedef LedGreen_TDeviceData *LedGreen_TDeviceDataPtr ; /* Pointer to the device data structure. */
...
LDD_TDeviceData* LedGreen_Init(LDD_TUserData *UserDataPtr)
{
  ...
  LedGreen_TDeviceDataPtr DeviceDataPrv;
...
bool LedGreen_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  PortData = GPIO_PDD_GetPortDataOutput(LedGreen_MODULE_BASE_ADDRESS) & LedGreen_PORT_MASK;
...
void LedGreen_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(LedGreen_MODULE_BASE_ADDRESS, LedGreen_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(LedGreen_MODULE_BASE_ADDRESS, LedGreen_PORT_MASK);
  } /* !Val */
}
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_TogglePortDataOutputMask(LedGreen_MODULE_BASE_ADDRESS, LedGreen_PORT_MASK);
}
