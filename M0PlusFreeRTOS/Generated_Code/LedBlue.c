...
} LedBlue_TDeviceData;                 /* Device data structure type */

typedef LedBlue_TDeviceData *LedBlue_TDeviceDataPtr ; /* Pointer to the device data structure. */
...
LDD_TDeviceData* LedBlue_Init(LDD_TUserData *UserDataPtr)
{
  ...
  LedBlue_TDeviceDataPtr DeviceDataPrv;
...
void LedBlue_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PE_LDD_UnregisterDeviceStructure(PE_LDD_COMPONENT_LedBlue_ID);
...
bool LedBlue_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  PortData = GPIO_PDD_GetPortDataOutput(LedBlue_MODULE_BASE_ADDRESS) & LedBlue_PORT_MASK;
...
void LedBlue_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(LedBlue_MODULE_BASE_ADDRESS, LedBlue_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(LedBlue_MODULE_BASE_ADDRESS, LedBlue_PORT_MASK);
  } /* !Val */
}
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_TogglePortDataOutputMask(LedBlue_MODULE_BASE_ADDRESS, LedBlue_PORT_MASK);
}
