...
#define TSS_ONFAULT_CALLBACK                   TSSTouch_fOnFault /* Identifier of the user's OnFault callback */

#define TSS_ONINIT_CALLBACK                    TSSTouch_fOnInit /* Identifier of the user's OnInit callback */
...
#define TSS_C0_STRUCTURE            TSSTouch_cKey0    /* Name of the C&S struct to create */
#define TSS_C0_CALLBACK             TSSTouch_fCallBack0 /* Identifier of the user's callback */
